        ...
        <div className="flex items-center gap-3 min-h-10">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2.5">
              <h1 className="text-base font-medium text-zinc-900 dark:text-zinc-100">{campusLabel} campus</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-6">
          <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800 p-2.5 sm:p-4 flex flex-col gap-1 sm:gap-1.5 min-w-0">
            ...
            <p className="text-2xl font-medium text-zinc-900 dark:text-zinc-100 leading-tight">{totalCount}</p>
            <p className="text-[11px] text-zinc-400 truncate">all registered</p>
          </div>
          <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800 p-2.5 sm:p-4 flex flex-col gap-1 sm:gap-1.5 min-w-0">
            <div className="flex items-center justify-between gap-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
          <div className="flex overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0 scrollbar-none">
            <div className="flex items-center gap-1.5 bg-white dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800 p-1 shrink-0">
              {[
                { key: "all", label: "All" },
                ...
                <button
                  ...
                  className={`px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors whitespace-nowrap min-h-10 ${
                    statusFilter === f.key
          ...
          <div className="flex items-center gap-2 sm:ml-auto">
            <div className="flex items-center gap-2 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3.5 py-2.5 sm:py-2 text-sm text-zinc-400 flex-1 sm:flex-initial sm:w-60 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/10 transition-colors">
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <button onClick={() => startEdit(student)} className="w-10 h-10 sm:w-8 sm:h-8 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex items-center justify-center text-zinc-400 hover:text-zinc-600 hover:border-zinc-300 hover:bg-zinc-50 transition-colors active:bg-zinc-100" title="Edit">
                        ...
                        <button onClick={() => handleDelete(student.id, `${student.firstName} ${student.lastName}`)} className="w-10 h-10 sm:w-8 sm:h-8 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex items-center justify-center text-zinc-400 hover:text-red-500 hover:border-red-200 hover:bg-red-50 transition-colors active:bg-red-100" title="Delete">
                        ...
                        {student.applications.map((app) => (
                          <div key={app.id} className="flex items-center justify-between py-1.5">
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              {app.status === "APPROVED" && (
                                <a href={`/api/admin/admission-letter?studentId=${student.id}`} target="_blank" className="inline-flex items-center gap-1 px-3 py-1.5 text-[11px] font-medium rounded-lg border border-blue-700 text-blue-700 hover:bg-blue-50 transition-colors">
