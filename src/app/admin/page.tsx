        ...
        <header className="bg-white border-b border-zinc-200 px-6 lg:px-8 py-3.5 sticky top-0 z-30">
          <div className="flex items-center justify-between">
            <div className="lg:pl-0 pl-10">
              <h1 className="text-base font-medium text-zinc-900">{campusLabel} campus dashboard</h1>
        ...
        <main className="px-6 lg:px-8 py-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-5">
            <div className="bg-white border border-zinc-200 rounded-xl p-4 flex flex-col gap-2">
              ...
              <p className="text-2xl font-medium text-zinc-900">{totalCount}</p>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            {student.educationQualification && (
                              <p className="text-xs text-zinc-400 mt-0.5">Education: {student.educationQualification}</p>
                            )}
                          </div>
                        </div>
