        ...
        <div className="flex items-center gap-3 min-h-10">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2.5">
              <h1 className="text-base sm:text-lg font-semibold text-zinc-900 dark:text-zinc-100">{campusLabel} campus</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-6">
          <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800 p-2.5 sm:p-4 flex flex-col gap-1 sm:gap-1.5 min-w-0">
            ...
            <p className="text-lg sm:text-2xl font-bold text-zinc-900 dark:text-zinc-100 leading-tight">{totalCount}</p>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
          ...
          <div className="flex items-center gap-2 sm:ml-auto">
            <div className="flex items-center gap-2 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3.5 py-2.5 sm:py-2 text-sm text-zinc-400 flex-1 sm:flex-initial sm:w-60 focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/10 transition-all">
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-1 shrink-0">
                        <button onClick={() => startEdit(student)} className="w-10 h-10 sm:w-8 sm:h-8 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex items-center justify-center text-zinc-400 hover:text-zinc-600 hover:border-zinc-300 hover:bg-zinc-50 transition-all active:bg-zinc-100" title="Edit">
