      ...
      <main className="px-6 lg:px-8 py-6 max-w-4xl">
        ...
        {courses.length === 0 ? (
          <div className="bg-white dark:bg-zinc-950 rounded-xl border border-zinc-200/80 dark:border-zinc-700/80 p-12 text-center">
            <svg className="w-12 h-12 text-zinc-300 dark:text-zinc-600 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">No courses added yet</p>
          </div>
        ) : (
          <div className="space-y-6">
            {Array.from(
              ...
              <div key={group.dept}>
                <h3 className="text-xs font-medium text-zinc-400 dark:text-zinc-500 mb-2 px-1">{group.dept} ({group.courses.length})</h3>
